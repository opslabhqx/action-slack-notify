...
# This script is specifically designed for the GitHub Action opslabhqx/slacknotify-action@v1.
...
function check_notify_slack() {
    ...
    define_var_optional "GITHUB_COMMIT_MESSAGE" # Does not work on workflow_dispatch
}
...
function send_notify_slack() {
    ...
    json_payload=$(jq -n \
        ...
        '{ "blocks": [ { "type": "header", "text": { "type": "plain_text", "text": $prefix } }, { "type": "section", "text": { "type": "mrkdwn", "text": $message } }, { "type": "context", "elements": [ { "type": "mrkdwn", "text": $committer }, { "type": "mrkdwn", "text": $branch_tag }, { "type": "mrkdwn", "text": $pipeline_url } ] }, { "type": "context", "elements": [ { "type": "mrkdwn", "text": $commit_msg } ] } ] }')
